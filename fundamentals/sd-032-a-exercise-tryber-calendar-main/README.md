...
- Use o comando: `git clone git@github.com:tryber/sd-032-a-exercise-tryber-calendar.git`
- Entre na pasta do repositório que você acabou de clonar
  - `cd sd-032-a-exercise-tryber-calendar`
...
- Verifique se você está na raiz do projeto
  - Exemplo: `pwd` -> o retorno vai ser algo do tipo _/Users/maria/code/**sd-032-a-exercise-tryber-calendar**_
...
- Vá até a página de *Pull Requests* do [repositório no GitHub](https://github.com/tryber/sd-032-a-exercise-tryber-calendar/pulls)
...
- Volte até a [página de *Pull Requests* do repositório](https://github.com/tryber/sd-032-a-exercise-tryber-calendar/pulls) e confira se seu *Pull Request* está criado
